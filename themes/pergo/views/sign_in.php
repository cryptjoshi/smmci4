<?php echo view('Themes\Pergo\Views\blocks\header',array('display_html' => false)); ?>
      ...
      <div>
        ...
        <div class="form-group">
          <label class="custom-control custom-checkbox">
            ...
            <span class="custom-control-label"><?=lang("app.remember_me")?></span>
            <a href="<?=cn("auth/forgot_password")?>" class="float-right small"><?=lang("app.forgot_password")?></a>
          </label>
        </div>
        <div class="form-footer">
          <button type="submit" class="btn btn-pill btn-2 btn-block btn-submit btn-gradient"><?=lang("app.login")?></button>
        </div>
      </div>
    </form>
...
<?php echo view('Themes\Pergo\Views\blocks\footer',array('display_html' => false)); ?>