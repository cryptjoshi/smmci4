              ...
              <div class="row">        
                  <div class="col-sm-12 col-md-12 col-lg-6">
                      <div class="intro_text">
                          <h1 class=""><?=lang("app.resellers_1_destination_for_smm_services")?></h1>
                          <p class=""><?=lang("app.save_time_managing_your_social_account_in_one_panel_where_people_buy_smm_services_such_as_facebook_ads_management_instagram_youtube_twitter_soundcloud_website_ads_and_many_more")?></p>
                          <?php
                            if (session('uid')) {
                          ?>
                          <div class="btn">
                            <a href="<?=cn('auth/signup')?>" class="btn btn-pill btn-gradient btn-signin btn-submit btn-lg"><?=lang("app.get_start_now")?></a>
                          </div>
                          <?php }?>
                      </div>
                  </div>
          ...
          <div class="row justify-content-center m-b-20">
            <div class="col-lg-10">
              <div class="section-title text-center">
                ...
                <h3 class="title"><?php echo lang("app.reasons_why_you_should_try_our_panel"); ?> <span> <?php echo lang("app.let_us_help_you_build_your_online_presence_quickly_and_efficiently"); ?></span></h3>
              </div>
            </div>
          </div>
          <div class="row justify-content-center">
              <div class="col-lg-4 col-md-7 col-sm-8" data-aos="fade-up" data-aos-duration="500">
                  <div class="sigle-service text-center m-t-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeIn;">
                      ...
                      <div class="services-content m-t-30">
                        <h4 class="services-title"><?php echo lang("app.best_quality"); ?></h4>
                        <p class="text"><?php echo lang("app.the_highest_quality_smm_services_to_meet_your_needs"); ?></p>
                      </div>
                  </div>
              </div>
              <div class="col-lg-4 col-md-7 col-sm-8" data-aos="fade-up" data-aos-duration="1000">
                  <div class="sigle-service text-center m-t-30">
                      ...
                      <div class="services-content m-t-30">
                        <h4 class="services-title"><?php echo lang("app.diverse_payment_options"); ?></h4>
                        <p class="text"><?php echo lang("app.we_have_a_good_amount_of_different_payment_options"); ?></p>
                      </div>
                  </div>
              </div>
              <div class="col-lg-4 col-md-7 col-sm-8" data-aos="fade-up" data-aos-duration="1500">
                  <div class="sigle-service text-center m-t-30">
                      ...
                      <div class="services-content m-t-30">
                        <h4 class="services-title"><?php echo lang("app.super_quick_delivery"); ?></h4>
                        <p class="text"><?php echo lang("app.we_provide_automated_services_with_quick_delivery"); ?></p>
                      </div>
                  </div>
              </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12 text-center">
            <div class="section-title pb-20">
              <h1><?php echo lang("app.what_we_offer"); ?></h1>
              <p><?php echo lang("app.comes_with_all_the_essential_features_and_elements_you_need_here_are_the_key_features_of_our_services_you_must_know"); ?></p>
            </div>
          </div>
        </div>
        ...
        <div class="row text-center" data-aos="fade-up" data-aos-delay="700">
          <div class="col-md-12 mx-auto">
            <div class="header-top">
              <div class="title">
                <?php echo lang("app.how_it_works"); ?>
              </div>
              <span class=""><?php echo lang("app.by_following_the_processes_below_you_can_make_any_order_you_want"); ?> </span>
            </div>
            <div class="col-md-12">
              <div class="row step-lists">
                ...
                <div class="col-sm-6 col-lg-3 step text-left">
                  <div class="header-name">
                    <h3><?php echo lang("app.register_and_log_in"); ?></h3>
                    <p class="desc"><?php echo lang("app.creating_an_account_is_the_first_step_then_you_need_to_log_in"); ?></p>
                  </div>
                ...
                <div class="col-sm-6 col-lg-3 step text-left">
                  <div class="header-name">
                    <h3><?php echo lang("app.add_funds"); ?></h3>
                    <p class="desc"><?php echo lang("app.next_pick_a_payment_method_and_add_funds_to_your_account"); ?></p>
                  </div>
                ...
                <div class="col-sm-6 col-lg-3 step text-left">
                  <div class="header-name">
                    <h3><?php echo lang("app.select_a_service"); ?></h3>
                    <p class="desc"><?php echo lang("app.select_the_services_you_want_and_get_ready_to_receive_more_publicity"); ?></p>
                  </div>
                ...
                <div class="col-sm-6 col-lg-3 step text-left">
                  <div class="header-name">
                    <h3><?php echo lang("app.enjoy_superb_results"); ?></h3>
                    <p class="desc"><?php echo lang("app.you_can_enjoy_incredible_results_when_your_order_is_complete"); ?></p>
                  </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="item">
                  <div class="title">
                    ...
                    <h5><?php echo lang("app.smm_panels__what_are_they"); ?></h5>
                  </div>
                  <div class="body"><?php echo lang("app.an_smm_panel_is_an_online_shop_that_you_can_visit_to_puchase_smm_services_at_great_prices"); ?>
                  </div>
                </div>
                ...
                <div class="item">
                  <div class="title">
                    <i class="fe fe-plus plus-icon"></i>
                    <h5><?php echo lang("app.what_smm_services_can_i_find_on_this_panel"); ?></h5>
                  </div>
                  <div class="body"><?php echo lang("app.we_sell_different_types_of_smm_services__likes_followers_views_etc"); ?>
                  </div>
                </div>
                ...
                <div class="item">
                  <div class="title">
                    <i class="fe fe-plus plus-icon"></i>
                    <h5><?php echo lang("app.are_smm_services_on_your_panel_safe_to_buy"); ?></h5>
                  </div>
                  <div class="body"><?php echo lang("app.sure_your_accounts_wont_get_banned"); ?>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="item">
                  <div class="title">
                    <i class="fe fe-plus plus-icon"></i>
                    <h5><?php echo lang("app.how_does_a_mass_order_work"); ?></h5>
                  </div>
                  <div class="body"><?php echo lang("app.its_possible_to_place_multiple_orders_with_different_links_at_once_with_the_help_of_the_mass_order_feature"); ?> </div>
                </div>

                <div class="item">
                  <div class="title">
                    <i class="fe fe-plus plus-icon"></i>
                    <h5><?php echo lang("app.what_does_dripfeed_mean"); ?></h5>
                  </div>
                  <div class="body"><?php echo lang("app.grow_your_accounts_as_fast_as_you_want_with_the_help_of_dripfeed_how_it_works_lets_say_you_want_2000_likes_on_your_post_instead_of_getting_all_2000_at_once_you_can_get_200_each_day_for_10_days"); ?></div>
                </div>
              </div>
