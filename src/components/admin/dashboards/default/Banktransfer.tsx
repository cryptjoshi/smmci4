	...
	useEffect(() => {
		...
		const checkData = async () => {
		  ...
		  } else 
		  {
			...
			let res = await fetch('http://128.199.92.45:3003/reports/count/transfermonthly', { method: 'POST',
			  headers: {
         ...
         setLoading(false)
         lineChartOptionsOverallRevenue.xaxis.categories = data.data.daysArray;
