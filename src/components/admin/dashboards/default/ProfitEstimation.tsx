...
export default function ProfitEstimation(props: { [x: string]: any }) {
  ...
  const {Profit} = rest
	...
	// 		  let res = await fetch('http://128.199.92.45:3003/reports/count/userstatus', { method: 'POST',
	// 		  headers: {
  ...
  return (
    ...
    >
      ...
      <Box w="140px" mx="auto" mb="10px" mt="10px">
         <CircularProgress title="ลูกค้า Actived" percentage={ parseFloat(((Profit.data[0].sum/(Profit.data[0].sum+Profit.data[1].sum))*100).toFixed(2))} />     
