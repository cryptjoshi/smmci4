    ...
    <div class="row justify-content-between">
      ...
      <div class="col-12">
        <div class="form-group d-flex">
          <div>
            <a href="<?=cn('api_provider/services')?>" class="btn btn-secondary "><?php echo lang("app.import_services"); ?></a>
          </div>
          <div class="item-action dropdown action-options">
            <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown">
               <i class="fe fe-menu mr-2"></i> <?php echo lang("app.actions"); ?>
            </button>
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item ajaxActionOptions" href="<?=cn($module.'/ajax_actions_option/delete')?>"><i class="fe fe-trash-2 text-danger mr-2"></i> <?=lang("app.delele")?></a>
              <a class="dropdown-item ajaxActionOptions" href="<?=cn($module.'/ajax_actions_option/all_deactive')?>"><i class="fe fe-trash-2 text-danger mr-2"></i> <?=lang("app.all_deactivated_services")?></a>
              <a class="dropdown-item ajaxActionOptions" href="<?=cn($module.'/ajax_actions_option/deactive')?>"><i class="fe fe-x-square text-danger mr-2"></i> <?=lang("app.deactive")?></a>   
              <a class="dropdown-item ajaxActionOptions" href="<?=cn($module.'/ajax_actions_option/active')?>"><i class="fe fe-check-square text-success mr-2"></i> <?=lang("app.active")?></a>
            </div>
          </div>
        </div>
      </div>
