      ...
      <tr class="tr_<?=$row->ids?>">
        ...
        <td class="w-1 text-center">
          <label class="custom-switch">
            <input type="checkbox" name="item_is_refill" data-id="<?php echo $row->id; ?>" data-action="<?php echo cn($module.'/ajax_toggle_item_refil/'); ?>" class="custom-switch-input ajaxToggleItemStatus" <?php if(!empty($row->is_refill) && $row->is_refill == 1) echo 'checked'; ?>>
