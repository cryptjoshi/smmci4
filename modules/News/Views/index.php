          ...
          <tbody>
            <?php if (!empty($news)) {
              ...
              foreach ($news as $key => $row) {
                switch ($row->type) {
                  case 'new_services':
                    $type  = lang("app.new_services");
                    $color = "btn-info";
                    break;
                  case 'disabled_services':
                    $type = lang("app.disabled_services");
                    $color = "btn-orange";
                    break;
                  case 'updated_services':
                    $type = lang("app.updated_services");
                    $color = "btn-lime";
                    break;
                  case 'announcement':
                    $type = lang("app.announcement");
                    $color = "btn-primary";
                }
              $i++;
            ?>
            <tr class="tr_<?=$row->ids?>">
              ...
              <td> 
                ...
                ?>
                      ...
                      <?php }else{?>
                      <span class="btn round btn-danger btn-sm"><?=lang("app.expired")?></span>
                    <?php }}else{?>
              ...
              <td class="text-center">
                <div class="item-action dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a href="<?=cn("$module/ajax_notification/")?>" class="dropdown-item ajaxModal"><i class="dropdown-icon fe fe-eye"></i> <?=lang("app.view")?> </a>
