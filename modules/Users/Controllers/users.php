...
//require APPPATH.'/libraries/Phpspreadsheet_lib.php';
...
class Users extends BaseController {
	...
	public function __construct(){
		...
		$this->model = new \Modules\Users\Models\UsersModel();
		$this->tb_users                 = USERS;
	...
	public function index(){
		//echo APPPATH.'/libraries/Phpspreadsheet_lib.php';
	...
	public function update($ids = ""){
		...
		return view('Modules\Users\Views\update', $data);
	}
	...
	public function mail($ids = ""){
		...
		return view('Modules\Users\Views\mail_to_user', $data);
	}
	...
	public function add_funds_manual($ids = ""){
		...
		return view('Modules\Users\Views\add_funds_manual', $data);
	}
	...
	public function ajax_add_funds_manualy($ids = ""){
		...
		$this->model->common_insert($this->tb_transaction_logs, $data_transaction);
	...
	public function ajax_send_email(){
		...
		if (!empty($user)) {
			...
			if ($this->db->tableExists($this->tb_user_mail_logs)) {
				$data = array(
					'ids'                 => ids(),
					'uid'                 => session('uid'),
				...
				$this->model->common_insert($this->tb_user_mail_logs, $data);
			}
