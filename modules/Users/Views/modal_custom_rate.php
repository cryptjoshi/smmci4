<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <div class="modal-header">
      <h4 class="modal-title"></i> <?php echo lang("app.edit_custom_rates"); ?> (<?php echo $user->email; ?>)</h4>
    ...
    <form class="actionForm" action="<?php echo cn($module.'/ajax_save_custom_rates/'.$user->id); ?>" method="POST">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <select name="service-id" class="select-service-item" class="form-control custom-select">
                <option value="1"><?php echo lang("app.add_custom_rate"); ?></option>
                <?php
                  if ($services) {
      ...
      <div class="card-footer text-right">
        <div class="d-flex">
          ...
          <a href="javascript:void(0)" class="btn btn-link btn-remove-items"><?php echo lang("app.delete_all"); ?></a>
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
          <button type="submit" class="btn btn-success btn-lg ml-auto mr-2"><?php echo lang("app.save"); ?></button>
          <button type="button" class="btn btn-default btn-lg" data-dismiss="modal"><?php echo lang("app.close"); ?></button>
        </div>
      </div>
    </form>
  </div>
