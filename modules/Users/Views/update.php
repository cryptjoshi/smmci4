            ...
            <div class="row">
              <?php
                if (!empty($user->more_information)) {
                  ...
                  $account_number = htmlspecialchars(get_value($infors,"account_number"));
                }
              ?>  
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="form-group">
                  <label for="projectinput5"><?php echo lang('account_number'); ?></label>
                  <input class="form-control square" name="account_number" type="text" value="<?php echo (!empty($account_number))? $account_number: ''?>">
                </div>
              </div>
              <div class="col-md-12 col-sm-12 col-xs-12">
                <input type="hidden" name="{csrf_token}" value="{csrf_hash}">
