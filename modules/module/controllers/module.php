...
use Modules\Module\Models\module_model; 
...
class module extends BaseController {
	...
	public function __construct(){
		//parent::__construct();
		helper('common');
		$this->model= new module_model();//('model', 'model');
	...
	public function update(){
		...
		$this->model->db->update($this->tb_purchase, ["purchase_code" => $purchase_code], ["pid" => "23595718"]);
	...
	public function ajax_install_module(){
		...
		if(empty($item)){
			$this->model->db->insert($this->tb_purchase, $data);
		}else{
			$this->model->db->update($this->tb_purchase, $data, array("id" => $item->id));
		}
