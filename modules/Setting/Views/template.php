    ...
    <div class="card content">
      <div class="card-header">
        <h3 class="card-title"><i class="fe fe-edit"></i> <?=lang("app.email_template")?></h3>
      </div>
      <div class="card-body">
        <form class="actionForm" action="<?=cn("$module/ajax_general_settings")?>" method="POST" data-redirect="<?php echo get_current_url(); ?>">
          <div class="row">
            <div class="col-md-12 col-lg-12">
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.email_verification_for_new_customer_accounts")?></h5>
              <div class="form-group">
                <label class="form-label"><?=lang("app.subject")?></label>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.new_user_welcome_email")?></h5>
              <div class="form-group">
                <label class="form-label"><?=lang("app.subject")?></label>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.new_user_notification_email")?></h5 class="text-info">
              <div class="form-group">
                <label class="form-label"><?=lang("app.subject")?></label>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.password_recovery")?></h5 class="text-info">
              <div class="form-group">
                <label class="form-label"><?=lang("app.subject")?></label>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.payment_notification_email")?></h5 class="text-info">
              <div class="form-group">
                <label class="form-label"><?=lang("app.subject")?></label>
              ...
              <div class="form-group">
                <div class="small">
                  <strong><?=lang("app.note")?></strong> <?=lang("app.you_can_use_following_template_tags_within_the_message_template")?><br> 
                  <ul>
                    <li>{{user_firstname}} - <?=lang("app.displays_the_users_first_name")?></li>
                    <li>{{user_lastname}} - <?=lang("app.displays_the_users_last_name")?></li>
                    <li>{{user_email}} - <?=lang("app.displays_the_users_email")?></li>
                    <li>{{user_timezone}} - <?=lang("app.displays_the_users_timezone")?></li>
                    <li>{{recovery_password_link}} - <?=lang("app.displays_recovery_password_link")?></li>
                  </ul>
                </div>
              </div>
            </div>
