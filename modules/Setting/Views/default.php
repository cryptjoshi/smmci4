    <div class="card content">
      <div class="card-header">
        <h3 class="card-title"><i class="fe fe-settings"></i> <?=lang("app.default_setting")?></h3>
      </div>
      <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <h5 class="text-info"><i class="fe fe-link"></i> <?php echo lang("app.header_menu_skin_colors"); ?></h5>
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.pagination")?></h5>
                  <div class="form-group">
                    <label><?=lang("app.limit_the_maximum_number_of_rows_per_page")?></label>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?= lang("app.refill_expiry_days") ?></h5>

              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label><?= lang("app.disable_refill_option_from_and_order_after_X_days") ?></label>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.default_tickets_log")?></h5>
              <div class="row">
                <div class="col-md-6">
                  <div class="custom-controls-stacked">
                    <label><?=lang("app.auto_clear_ticket_lists")?></label>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label><?=lang("app.clear_ticket_lists_after_x_days_without_any_response_from_user")?></label>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.default_service")?></h5>
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label><?=lang("app.default_min_order")?></label>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label><?=lang("app.default_max_order")?></label>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label><?=lang("app.default_price_per_1000")?></label>
                    <input class="form-control" name="default_price_per_1k" value="<?=get_option('default_price_per_1k',"0.80")?>">
                  </div>
                </div>
              </div>

              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.dripfeed_option")?></h5>
              <div class="row">
                <div class="col-md-12">
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                  ...
                  <small class="text-danger"><?=lang("app.note_please_make_sure_the_dripfeed_feature_has_the_active_status_in_api_provider_before_you_activate")?></small>
                </div>
                
                <div class="col-md-6">
                  <div class="form-group">
                    <label><?=lang("app.default_runs")?> </label>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label><?=lang("app.default_interval_in_minutes")?></label>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.notification_popup_at_home_page")?></h5>
              <div class="row">
                <div class="col-md-12">
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="fe fe-link"></i> <?=lang("app.disable_home_page_langding_page")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="fe fe-link"></i> <?php echo lang("app.disable_signup_page"); ?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="fe fe-link"></i> <?=lang("app.explication_of_the_service_symbol")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="fe fe-link"></i> <?=lang("app.displays_the_service_lists_without_login_or_register")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="fe fe-link"></i> <?=lang("app.displays_news__announcement_feature")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="fe fe-link"></i> <?=lang("app.displays_api_tab_in_header")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-6">
                  <h5 class="m-t-10"><i class="fe fe-link"></i> <?=lang("app.displays_required_skypeid_field_in_signup_page")?></h5>
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
              ...
              <h5 class="m-t-10"><i class="fe fe-link"></i> <?=lang("app.displays_google_recapcha")?></h5>
              <div class="row">
                <div class="col-md-12">
                  <div class="custom-controls-stacked">
                    <label class="custom-control custom-checkbox">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label><?=lang("app.google_recaptcha_site_key")?></label>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label><?=lang("app.google_recaptcha_serect_key")?></label>
