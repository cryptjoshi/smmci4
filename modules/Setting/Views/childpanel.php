<div class="card content">
      <div class="card-header">
        <h3 class="card-title"><i class="fe fe-archive"></i> <?= lang("app.childpanel_setting") ?></h3>
    </div>
         <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="form-group">
                        <div class="form-label"><?= lang("app.childpanel_status") ?></div>
                    ...
                    <div class="form-group">
                        <label class="form-label"><?= lang("app.childpanel_price") ?>
                        </label>
                        ...
                        <small class="text-muted"><span class="text-danger">*</span> <?= lang("app.this_is_the_price_of_childpanel") ?></small>
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label"><?= lang("app.nameserver_1") ?>
                        </label>
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        <label class="form-label"><?= lang("app.nameserver_2") ?>
                        </label>
                        <div class="input-group">
                   ...
                   <h5 class="text-info"> <?=lang("app.childpanel_description")?></h5 class="text-info">
                   <div class="form-group">
