<div class="card content">
  <div class="card-header">
    <h3 class="card-title"><i class="fe fe-sliders"></i> <?= lang("app.affiliate_settings") ?></h3>
  </div>
  <div class="card-body">
    <form class="actionForm" action="<?= cn("$module/ajax_general_settings") ?>" method="POST" data-redirect="<?php echo get_current_url(); ?>">
      <div class="row">
        ...
        <div class="col-md-12 col-lg-12">
          ...
          <h5 class="text-info"><i class="fe fe-link"></i> <?= lang("app.enable_affiliate") ?></h5>
          ...
          <h5 class="text-info"><i class="fe fe-link"></i> <?= lang("app.affiliate_page_notice") ?></h5>
          <div class="form-group">
            <textarea rows="3" name="affiliate_notice" class="form-control"><?= get_option('affiliate_notice', "") ?></textarea>
          </div>

          <h5 class="text-info"><i class="fe fe-link"></i> <?= lang("app.affiliate_bonus") ?></h5>
          ...
          <div class="form-group">
            ...
            <small class="text-muted"><span class="text-danger">*</span> <?= lang("app.this_is_fund_which_will_be_added_to_the_affiliate_user_whenever_someone_signup_with_their_referral_code.") ?></small>
          </div>
