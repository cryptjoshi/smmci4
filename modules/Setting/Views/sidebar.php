    <div class="sidebar o-auto">
      ...
      <div class="list-group list-group-transparent mb-0">
        ...
        <a href="<?php echo cn($module."/affiliate")?>" class="list-group-item list-group-item-action <?php echo (segment(2) == 'affiliate') ? 'active' : ''?>"><span class="icon mr-3"><i class="fa fa-handshake-o"></i></span><?=lang("affiliate_setting")?></a>
        <a href="<?= cn($module . "/childpanel") ?>" class="list-group-item list-group-item-action <?php echo (segment(2) == 'childpanel') ? 'active' : '' ?>" data-content="other"><span class="icon mr-3"><i class="fe fe-box"></i></span><?= lang("Childpanel_setting") ?></a>
