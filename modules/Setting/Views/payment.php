    ...
    <div class="card content">
      <div class="card-header">
        <h3 class="card-title"><i class="fe fe-credit-card"></i> <?=lang("app.payment_integration")?></h3>
      </div>
      <div class="card-body">
        <form class="actionForm" action="<?=cn("$module/ajax_general_settings")?>" method="POST" data-redirect="<?=cn($module."?t=".$tab)?>">
          <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.transaction_limits")?></h5>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.environment")?></h5>
              <div class="form-group">
                <select  name="payment_environment" class="form-control square">
                  <option value="sandbox" <?=(get_option("payment_environment", "sandbox") == 'sandbox')? 'selected': ''?>><?=lang("app.sandbox_test")?></option>
                  <option value="live" <?=(get_option("payment_environment", "sandbox") == 'live')? 'selected': ''?>><?=lang("app.live")?></option>
                </select>
              </div>

              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.paypal")?></h5>
              ...
              <div class="form-group">
                <label class="form-label"><?=lang("app.paypal_client_id")?></label>
                <input class="form-control" name="paypal_client_id" value="<?=get_option('paypal_client_id',"")?>">
              </div>

              <div class="form-group">
                <label class="form-label"><?=lang("app.paypal_client_secret")?></label>
                <input class="form-control" name="paypal_client_secret" value="<?=get_option('paypal_client_secret',"")?>">
              </div>

              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.stripe")?></h5>
              ...
              <div class="form-group">
                <label class="form-label"><?=lang("app.publishable_key")?></label>
                <input class="form-control" name="stripe_publishable_key" value="<?=get_option('stripe_publishable_key',"")?>">
              </div>

              <div class="form-group">
                <label class="form-label"><?=lang("app.secret_key")?></label>
                <input class="form-control" name="stripe_secret_key" value="<?=get_option('stripe_secret_key',"")?>">
              </div>
			  
				<h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.razor_pay_by_-_shreyans")?></h5>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.2Checkout")?></h5 class="text-info">
              <div class="form-group">
                <div class="form-label"><?=lang("app.status")?></div>
                <div class="custom-controls-stacked">
                  <label class="custom-control custom-checkbox">
              ...
              <div class="form-group">
                <label class="form-label"><?=lang("app.private_key")?></label>
                <input class="form-control" name="2checkout_private_key" value="<?=get_option('2checkout_private_key',"")?>">
              </div>

              <div class="form-group">
                <label class="form-label"><?=lang("app.2checkout_account_number_sellerid")?></label>
                <input class="form-control" name="2checkout_seller_id" value="<?=get_option('2checkout_seller_id',"")?>">
              </div> 

              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.manual_payment")?></h5 class="text-info">
              <div class="form-group">
                <div class="form-label"><?=lang("app.status")?></div>
                <div class="custom-controls-stacked">
                  <label class="custom-control custom-checkbox">
              ...
              <div class="form-group">
                ...
                <textarea rows="3" name="manual_payment_content" id="manual_payment_content" class="form-control plugin_editor"><?=get_option('manual_payment_content', lang("app.you_can_make_a_manual_payment_to_cover_an_outstanding_balance_you_can_use_any_payment_method_in_your_billing_account_for_manual_once_done_open_a_ticket_and_contact_with_administrator"))?>
                </textarea>
              </div>
