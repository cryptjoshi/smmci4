    ...
    <div class="card content">
      <div class="card-header">
        <h3 class="card-title"><i class="fe fe-edit-3"></i> <?php echo lang("app.cookie_policy_page"); ?></h3>
      </div>
      <div class="card-body">
        <form class="actionForm" action="<?=cn("$module/ajax_general_settings")?>" method="POST" data-redirect="<?php echo get_current_url(); ?>">
          <div class="row">
            <div class="col-md-12 col-lg-12">
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.status")?></h5>
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?php echo lang("app.content"); ?></h5 class="text-info">
              <div class="form-group">
