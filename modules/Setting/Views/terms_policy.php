    ...
    <div class="card content">
      <div class="card-header">
        <h3 class="card-title"><i class="fe fe-edit-3"></i> <?=lang("app.terms__policy")?></h3>
      </div>
      <div class="card-body">
        <form class="actionForm" action="<?=cn("$module/ajax_general_settings")?>" method="POST" data-redirect="<?php echo get_current_url(); ?>">
          <div class="row">
            <div class="col-md-12 col-lg-12">
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.content_of_terms")?></h5 class="text-info">
              ...
              <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("app.content_of_policy")?></h5 class="text-info">
              <div class="form-group">
                <label class="form-label"><?=lang("app.content")?></label>
