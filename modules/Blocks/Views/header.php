        ...
        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-arrow">
			  ...
			  <a href="<?=cn('refill/log')?>" class="dropdown-item "><?=lang("refill_logs")?></a>
          ...
          <li class="nav-item dropdown">
            <a href="<?=cn('affiliate')?>" class="nav-link <?=(segment(1) == 'affiliate')?"active":""?>"><i class="fa fa-handshake-o"></i> &nbsp;<?=lang("Affiliate")?></a>
          </li>
          <?php }?>
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-arrow">
              ...
              <a href="https://smartpanelsmm.com/docs/" class="dropdown-item"><?=lang("Documentation")?></a>
              <?php } ?>
            </div>
          </li>
          <?php } ?>
