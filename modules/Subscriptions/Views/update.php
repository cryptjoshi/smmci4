              ...
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control square"  disabled value="<?=(!empty($order->api_service_id) && $order->api_service_id > 0 )? lang("app.api"): lang("app.manual")?>">
                  </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                  <div class="form-group">
                    <label ><?=lang("app.quantity")?> (min/max)</label>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label ><?=lang("app.actived_Posts")?></label>
