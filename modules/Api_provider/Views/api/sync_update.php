      ...
      <div class="modal-content">
        ...
        <form class="form actionSyncApiServices" action="<?=cn($module."/ajax_sync_services/$ids")?>" data-redirect="<?=cn($module)?>" method="POST">
          <div class="modal-header bg-pantone">
            <h4 class="modal-title"><i class="fe fe-refresh-cw"></i> <?=lang("app.sync_services")?></h4>
              ...
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label ><?=lang("app.api_provider_name")?></label>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label><?=lang("app.synchronous_request")?></label>
                    <select name="request" class="form-control square">
                      <option value="0"><?=lang("app.current_service")?></option>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label class=" custom-control custom-checkbox">
                      ...
                      <span class="custom-control-label"> <?php echo lang("app.sync_new_price"); ?></span>
                    </label>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label class=" custom-control custom-checkbox">
                      ...
                      <span class="custom-control-label"> <?php echo lang("app.sync_original_price"); ?></span>
                    </label>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label class=" custom-control custom-checkbox">
                      ...
                      <span class="custom-control-label"> <?php echo lang("app.sync_service_name"); ?></span>
                    </label>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label class=" custom-control custom-checkbox">
                      ...
                      <span class="custom-control-label"> <?php echo lang("app.sync_min_max_dripfeed"); ?></span>
                    </label>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label class=" custom-control custom-checkbox">
                      ...
                      <span class="custom-control-label"> <?php echo lang("app.sync_services_description_only_support_hq_smartpanel"); ?></span>
                    </label>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="custom-control custom-checkbox">
                      ...
                      <span class="custom-control-label"><?=lang("app.auto_convert_to_new_currency_with_currency_rate_like_in")?><a href="<?=cn("setting")."?t=currency"?>" target="_blank"><?=lang("app.currency_setting_page")?></a></span>
                    </label>
                  </div>
                </div>

                <div class="col-md-12">
                    <span class="text-primary small"><?=lang("app.note")?></span>
                    <ul class="text-primary small">
                      <li><?=lang("app.current_service_sync_all_the_current_services")?></li>
                      <li><?=lang("app.all_auto_add_new_service_if_the_service_doesnt_exists")?></li>
                    </ul>
                </div>
