                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    ...
                    <select name="request" class="form-control square">
                      <option value="0" <?=(isset($sync_request) && $sync_request == 0)? "selected" : ''?>><?=lang("app.current_service")?></option>
                      <option value="1" <?=(isset($sync_request) && $sync_request == 1)? "selected" : ''?>><?=lang("app.all")?></option>
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="custom-control custom-checkbox">
                      ...
                      <span class="custom-control-label"><?=lang("app.enable_sync_the_price_min_max_of_current_services")?></span>
                    </label>
                  </div>
                </div>
