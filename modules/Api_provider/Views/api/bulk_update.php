      ...
      <div class="modal-content">
        ...
        <form class="form actionForm" action="<?=cn($module."/ajax_bulk_services/$ids")?>" data-redirect="<?=cn($module)?>" method="POST">
          <div class="modal-header bg-pantone">
            <h4 class="modal-title"><i class="fa fa-edit"></i> <?=lang("app.bulk_add_all_services")?></h4>
          ...
          <div class="modal-body">
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <label><?=lang("app.bulk_add_limit")?></label>
                ...
                <div class="col-md-12">
                  <p class="text-primary"><?=lang("app.note_when_you_use_this_feature_the_system_will_bulk_add_services_categories_from_api_provider_and_set_price_percentage_increase")?></p>
                </div>
