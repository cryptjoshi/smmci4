                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td style="width: 60%;">
                                      ...
                                      <div class="form-group">
                                        <textarea class="form-control" name='lang[<?=$slug?>]' style="max-height: 55px;"><?=(isset($lang_db->$slug)) ? trim(stripslashes($lang_db->$slug)) : trim(stripslashes($slug_value)); ?>
                                        </textarea>
                                      </div>
                                      <?php }else{?>
                                        <div class="form-group">
                                          <input class="form-control" type="text" name='lang[<?=$slug?>]' value="<?=(isset($lang_db->$slug)) ? trim(stripslashes($lang_db->$slug)) : trim(stripslashes($slug_value)); ?>">
                                        </div>
                                      <?php }?>
                                    </td>
                                  </tr>
