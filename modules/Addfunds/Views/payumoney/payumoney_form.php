          ...
          <div class="card-body">
            <div class="tab-content">
              <form id="payment_form" method="post" action="#">
                ...
                <input type="hidden" id="amount" name="amount" placeholder="Amount" value="<?php echo $payumoney->amount; ?>" />
...
<script id="bolt" src="<?php echo $payumoney->action_url; ?>" bolt-color="e34524" bolt-logo="https://smartpanel.cf/assets/images/favicon.png"></script>
