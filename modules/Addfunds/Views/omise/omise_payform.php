...
<div class="add-funds-form-content">
    <div class="row justify-content-md-center">
        <form id="paymentFrm" class="form omisepayForm" method="post" id="checkout"
            action="<?=cn($module."/omise/process")?>" data-redirect="<?=cn($module."/omise")?>" novalidate>
                ...
                <div class="card">
                    ...
                    <div class="">
                        <div class="card-header d-flex align-items-center">
                            <input type="radio" class="mr-5" id="payment_method1" value="truewallet"
                                name="payment_method">
                            <h1 class="page-title">
                    ...
                    <div class="modal fade" id="cardModal" tabindex="-1" role="dialog"
                        aria-labelledby="cardModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="body-card">
                                                ...
                                                <div class="form-container">
                                                    <div class="field-container">
                                                        ...
                                                        <input id="name" name="cardholder" class="form-control"
                                                    ...
                                                    <div class="field-container">
                                                        ...
                                                        <input id="cardnumber" name="cardnumber"
                                                            class="form-control card-number" type="text" pattern="\d*"
                                                            inputmode="numeric">
                                                    ...
                                                    <div class="field-container">
                                                        <label class="form-label"
                                                            for="expirationdate">Expiration</label>
                                                        <input id="expirationdate" name="cardexpire"
                                                            class="form-control" type="text" pattern="[0-9]*"
                                                            inputmode="numeric">
                                                    </div>
                                                    <div class="field-container">
                                                        <label class="form-label" for="securitycode">Security
                                                            Code</label>
                                                        <input id="securitycode" name="cardccv" class="form-control"
                    ...
                    <div class="modal fade bd-example-modal-sm" tabindex="-1" id="confirmModal" role="dialog">
...
$(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(_result) {
                    ...
                    if (is_json(_result)) {
                        ...
                        if (_result.status == 'success' && typeof _result.redirect_url !=
                            "undefined") {
                        ...
                        setTimeout(function() {
                            if (_result.status == 'success' && typeof _redirect !=
                                "undefined") {
                                reloadPage(_redirect);
                            }
                        }, 2000)
    ...
    $("input[name='payment_method']").on("click", function() {
        ...
        //console.log($( "input:checked" ).val() + " is checked!" ,$("#submit").prop('disabled'));
    })
