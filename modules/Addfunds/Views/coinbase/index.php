    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="for-group text-center">
          ...
          <p class="p-t-10"><small><?=sprintf(lang("app.you_can_deposit_funds_with_paypal_they_will_be_automaticly_added_into_your_account"), 'Coinbase')?></small></p>
        </div>
        ...
        <div class="form-group">
          <small class=""><?=lang("app.transaction_fee")?>: <strong><?=(get_option("coinbase_chagre_fee", 1))?>%</strong></small>
        </div>
        <div class="form-group">
