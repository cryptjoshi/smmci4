      ...
      <div class="col-md-5">
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h3 class="card-title"><?=lang("app.perfect_money_confirmation")?></h3>
          </div>
          <div class="card-body">
            <div class="tab-content" id="result_notification">
              <form id="paymentFrom" method="post" action="<?=cn($module."/perfectmoney/create_payment")?>">
                <div class="form-group">
                  <label class="form-label"><?php echo sprintf(lang("app.total_amount_XX_includes_fee"), $perfectmoney->PAYMENT_UNITS)?></label>
