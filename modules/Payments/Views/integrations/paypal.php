      ...
      <div class="modal-content">
        ...
        <form class="form actionForm" action="<?php echo $url?>" data-redirect="<?php echo cn($module); ?>" method="POST">
          ...
          <div class="modal-body">
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="payment_params[new_users]" class="form-control square">
                      <option value="1" <?php echo (!empty($payment->new_users) && $payment->new_users == 1)? 'selected' : '' ; ?>><?php echo lang("app.allowed"); ?></option>
                      <option value="0" <?php echo (isset($payment->new_users) && $payment->new_users != 1)? 'selected' : '' ; ?>><?php echo lang("app.not_allowed"); ?></option>
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="payment_params[status]" class="form-control square">
                      <option value="1" <?php echo (!empty($payment->status) && $payment->status == 1) ? 'selected' : '' ; ?>><?php echo lang("app.active")?></option>
                      <option value="0" <?php echo (isset($payment->status) && $payment->status != 1) ? 'selected' : '' ; ?>><?php echo lang("app.deactive")?></option>
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="form-label"><?php echo lang("app.take_fee_from_user"); ?></label>
                    <select name="payment_params[take_fee_from_user]" class="form-control square">
                      <option value="1" <?php echo (!empty($option->take_fee_from_user) && $option->take_fee_from_user == 1) ? 'selected' : '' ; ?>><?php echo lang("app.active")?></option>
                      <option value="0" <?php echo (isset($option->take_fee_from_user) && $option->take_fee_from_user != 1) ? 'selected' : '' ; ?>><?php echo lang("app.deactive")?></option>
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <select name="payment_params[option][environment]" class="form-control square">
                      <option value="sandbox" <?php echo (isset($option->environment) && $option->environment == 'sandbox') ? 'selected' : ''; ?>><?php echo lang("app.sandbox_test"); ?></option>
                      <option value="live" <?php echo (isset($option->environment) && $option->environment == 'live') ? 'selected' : ''; ?>><?php echo lang("app.live"); ?></option>
                    </select>
                  </div>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn round btn-default btn-min-width mr-1 mb-1" data-dismiss="modal"><?php echo lang("app.cancel")?></button>
          </div>
        </form>
      </div>
    </div>
