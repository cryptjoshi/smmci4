<div id="main-modal-content">
    <div class="modal-right">
        ...
        ?>
                ...
                <form class="form actionForm" action="<?php echo $url?>" data-redirect="<?php echo cn($module); ?>"
                    method="POST">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control square" name="payment_params[name]"
                                            value="<?php echo (!empty($payment->name))? $payment->name : '' ; ?>">
                                    </div>
                                </div>
                  ...
                  $options = $payment_params->options;
                ?>
                                <div class="col-md-12">
                                    <div class="form-group">
                      ...
                      ?>
                                            <option value="<?=$i?>"
                                                <?=(isset($option->tnx_fee) && $option->tnx_fee == $i)? "selected" : ''?>>
                                                <?php echo $i; ?>%</option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            name="payment_params[option][public_key]"
                                            value="<?php echo (isset($option->public_key)) ? $option->public_key : ''; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label class="form-label">Secret Key<span class="form-required">*</span></label>
                                        <input type="text" class="form-control"
                                            name="payment_params[option][secret_key]"
                                            value="<?php echo (isset($option->secret_key)) ? $option->secret_key : ''; ?>">
                                    </div>
                                </div>
