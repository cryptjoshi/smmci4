            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label class="form-label">ToyyibPay Secret Key<span class="form-required">*</span></label>
                  ...
                  <div class="form-group">
                    <label class="form-label">ToyyibPay Category Code<span class="form-required">*</span></label>
                    <input type="text" class="form-control"  name="payment_params[option][category_code]" value="<?php echo (isset($option->category_code)) ? $option->category_code : ''; ?>">
                  </div>
                </div>
