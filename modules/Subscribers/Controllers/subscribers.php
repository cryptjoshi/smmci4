<?php
namespace Modules\Subscribers\Controllers;
use App\Controllers\BaseController;
use Modules\Subscribers\Models\subscribers_model; 
...
class subscribers extends BaseController {
	...
	public function __construct(){
		...
		//Config Module
		$this->model =  new subscribers_model();
		$this->tb_users                 = USERS;
	...
	public function index(){
		...
		return view('Modules\Subscribers\Views\index', $data);
	}
	...
	public function mail($ids = ""){
		...
		return view('Modules\Subscribers\Views\mail_to_user', $data);
	...
	public function ajax_search(){
		...
		return view('Modules\Subscribers\Views\ajax_search', $data);
	}
